...
<div class="sm:col-span-4">
    ...
    <div class="mt-2">
        <input type="text" name="image_url" id="image_url" class="block w-full border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
    </div>
</div>
